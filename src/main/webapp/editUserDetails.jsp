...
<html>
    ...
    <body>
        ...
        <%
            ...
            //display error message incase user attempts to update their email to one which already exists in the database
            if (errorMsg != null) {
        %>
        <div>
            <%=errorMsg%>
        ...
        <%
            ...
            //grab username, firstname, lastname, country and email attributes from the user's record in userprofiles table
